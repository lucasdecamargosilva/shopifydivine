(function () {
    ...
    const styles = `
        ...
        /* FIX iOS ZOOM: Garantindo font-size 16px em todos os inputs e resetando zoom no focus */
        .q-input { 
            width: 100%; 
            padding: 22px 18px; 
        ...
        @media (min-width: 768px) {
            ...
            .q-metrics-row { display: flex !important; gap: 15px; margin-bottom: 30px; }
            .q-metric-card { flex: 1; background: transparent; border: 1px solid var(--q-border); border-radius: 0; padding: 16px; }
            .q-metric-label { font-size: 9px; font-weight: 600; text-transform: uppercase; letter-spacing: 1.5px; color: var(--q-text-light); margin-bottom: 6px; display: block; }
            .q-metric-value { font-size: 20px; font-weight: 700; color: var(--q-text); }
            .q-metric-unit { font-size: 12px; color: var(--q-text-light); margin-left: 2px; }
            .q-size-card {
            ...
            .q-size-info { flex: 1; }
            .q-size-info strong { display: block; font-size: 11px; font-weight: 600; color: var(--q-text); margin-bottom: 4px; letter-spacing: 1.5px; text-transform: uppercase; }
            .q-size-info span { font-size: 9px; color: var(--q-text-light); letter-spacing: 1px; text-transform: uppercase; display: block; }
            .q-size-check { color: var(--q-primary); font-size: 24px; flex-shrink: 0; }
