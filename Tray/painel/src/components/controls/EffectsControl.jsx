...
export default function EffectsControl({ design, onChange, activeButton }) {
  const isBuyButton = activeButton === 'buy_button';
  return (
    <div className="space-y-3">
      <div>
        <label className="text-xs font-medium text-brand-gray">Animacao</label>
        <select
